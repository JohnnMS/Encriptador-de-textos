...
function Encriptar () {
    ...
    // Flag para ver si fue encriptado o no para modificar mensaje copiado
    esEncriptado = true;
...
function copiar_encriptado () {
    ...
    alert(`El texto ${(esEncriptado === true) ? 'encriptado' : 'desencriptado'} ha sido copiado en el portapapeles...`)
